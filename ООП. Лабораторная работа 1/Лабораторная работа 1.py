...
class Book:
    ...
    def pages_to_read(self, readen_pages: int) -> None:
        ...
        :param readen_pages: Количество прочитанных страниц
    ...
    def book_is_readen(self) -> bool:
        """
        Функция, которая проверяет является ли книга прочитанной.

        :return: Является книга прочитанной
